...
class StreamingTopology {
  ...
  private fun keyValueMapper(key: String, value: Transaction): String {
    return value.category
  }

  private fun valueJoiner(value: Transaction, tableValue: String): Transaction {
    value.category = tableValue
    return value
  }
